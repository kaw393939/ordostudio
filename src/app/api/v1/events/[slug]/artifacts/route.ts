...
import { createArtifact, EngagementNotFoundError } from "../../../../../../lib/api/engagements";
import { hal, problem } from "../../../../../../lib/api/response";
import { withRequestLogging } from "../../../../../../lib/api/request-logging";
import { withRateLimit } from "../../../../../../lib/api/rate-limit-wrapper";
import { parsePayload } from "../../../../../../lib/api/validate";
import { artifactSchema } from "../../../../../../lib/api/schemas";
...
async function _POST(request: Request, context: { params: Promise<{ slug: string }> }) {
  ...
  const parsed = parsePayload(artifactSchema, raw, request);
  ...
  try {
    ...
    return hal(created as unknown as Record<string, unknown>, {
      self: { href: `/api/v1/events/${slug}/artifacts` },
